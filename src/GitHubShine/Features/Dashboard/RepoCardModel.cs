...
public sealed class RepoCardModel(MonitoredAccount account, MonitoredRepo repo)
{
    ...
    public string RepoUrl => $"{Account.WebBaseUrl}/{Repo.FullName}";
    public string IssuesUrl => $"{Account.WebBaseUrl}/{Repo.FullName}/issues";
    public string PullsUrl => $"{Account.WebBaseUrl}/{Repo.FullName}/pulls";
    public string ActionsUrl => $"{Account.WebBaseUrl}/{Repo.FullName}/actions";
    public string StarsUrl => $"{Account.WebBaseUrl}/{Repo.FullName}/stargazers";
    public string ForksUrl => $"{Account.WebBaseUrl}/{Repo.FullName}/forks";
    public string WatchersUrl => $"{Account.WebBaseUrl}/{Repo.FullName}/watchers";
